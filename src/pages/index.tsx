...
import PeapleSVG from '../assets/peaple.svg'
      ...
      <S.Main>
        <S.Article className="first" background={theme.colors.blue_0}>
          <div>
            ...
            <section className="right">
              <img src="Studying.png" alt="Estudando" />
            </section>
          </div>
        </S.Article>
        ...
        <S.Article className="third">
          ...
          <div>
            ...
            <section className="right">
              <h2>
                Dê uma olhada nas perguntas mais recentes, talvez você já
                consiga ajudar alguém :)
              </h2>
            </section>
          </div>
        </S.Article>
